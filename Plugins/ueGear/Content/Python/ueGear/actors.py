...
def select_actors_in_current_level(actors):
	...
	unreal.EditorLevelLibrary().set_selected_level_actors(helpers.force_list(actors))
...
def get_actor_asset(actor):
	...
	if is_static_mesh:
		static_mesh_component = helpers.get_first_in_list(static_mesh_components)
		...
		skeletal_mesh_component = helpers.get_first_in_list(skeletal_mesh_components)
